...
from .views import contacts, IndexView, ProductDetailView, blog_list_view, ProductCreateView, ProductDeleteView, \
    ProductUpdateView, CategoryListView, CategoryDetailView#, CreateProductView
...
urlpatterns = [
    ...
    path('create/', ProductCreateView.as_view(), name='product_create'),  # URL для создания продукта
